...
def main():
    ...
    # --- copy the real images into futstats-ui/assets/ (renamed to UI filenames) ---
    assets_dir = f"{a.ui_dir}/assets"
    ...
    # --- video: referenced (not copied) to avoid an ~839 MB duplicate ---
    # relative to futstats-ui/index.html, resolves when serving from the repo root
    video_rel = ("../" + a.video) if os.path.exists(a.video) else ""
    ...
    results = {
        ...
        "assets": {
            "video": video_rel,
            "heatmap_match": "assets/heatmap_match.png",
            "heatmap_team_a": "assets/heatmap_team_a.png",
            "heatmap_team_b": "assets/heatmap_team_b.png",
            "pass_network_team_a": "assets/pass_network_team_a.png",
            "pass_network_team_b": "assets/pass_network_team_b.png",
            "radar_before": "",   # not generated by our pipeline
            "radar_after": "",    # not generated by our pipeline
        },
        "model_info": {
    ...
    data_dir = f"{a.ui_dir}/data"
    os.makedirs(data_dir, exist_ok=True)
    out = f"{data_dir}/results.json"
